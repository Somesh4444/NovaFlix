  ...
  useEffect(() => {
    const fetchTrendingMovies = async () => {
      try {
        ...
        console.error("Error collecting trending movies:", error);
      } finally {
        setLoading(false);
      }
    };
                ...
                <SwiperSlide key={movie.id} className="h-auto min-w-0">
                  ...
                  >
                    ...
                    <div className="relative aspect-2/3 w-full rounded-xl overflow-hidden bg-slate-900">
                      ...
                      {/* Trending Blockbuster Condition Flag Tag */}
                      ...
                      {/* Play Overlay Trigger (Converted to a clean div layout wrapper) */}
