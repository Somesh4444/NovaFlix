...
export default function TopRated() {
  ...
  useEffect(() => {
    const fetchTopRatedMovies = async () => {
      try {
        ...
        console.error("Error collecting top rated movies:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <section className="relative py-5 select-none overflow-hidden">
      {/* Container */}
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-end justify-between mb-6">
          ...
          <div className="flex gap-2">
            <button className="top-rated-prev w-9 h-9 rounded-xl bg-white/5 border border-white/10 hover:border-cyan-400/40 hover:bg-cyan-400/10 text-gray-400 hover:text-cyan-400 transition flex items-center justify-center cursor-pointer">
              <ChevronLeft size={16} />
            </button>

            <button className="top-rated-next w-9 h-9 rounded-xl bg-white/5 border border-white/10 hover:border-cyan-400/40 hover:bg-cyan-400/10 text-gray-400 hover:text-cyan-400 transition flex items-center justify-center cursor-pointer">
                ...
                <SwiperSlide key={movie.id} className="h-auto min-w-0">
                  ...
                  >
                    ...
                    <div className="relative aspect-2/3 w-full rounded-xl overflow-hidden bg-slate-900">
                      ...
                      {/* Top Rated Score Flag Tag Label Indicator */}
                      ...
                      {/* Play Overlay Triggers (Converted from <Link> to <div> to avoid nesting links) */}
